...
<body>	
	...
	<div class="contenido">
		...
		<form action="/ServletCurso" method="get">
			<table>
			<tr>
				<td class="fuenteLetra5">Codigo</td>
			...
			<tr>
				<td><input type="hidden" value="<%=getCodigo %>" name="codigoOriginal"></td>
				<td><input type="hidden" value="<%=session.getAttribute("logueado").toString()%>" name="correoProfesor"></td>
				<td><input type="text" placeholder="   descripcion" value="<%=getDescripcion%>" name="descripcion"></td>
			</tr>
			<tr>
